...
description: >
  ...
  Use this skill when the user signals end of a work session — e.g. "收工",
  "今天到这", "done", "wrap up", "that's it for today", "好了", "先这样".
...
`source: "lode-session-recap"`. If `artifact_index.enabled` is `false`, config
