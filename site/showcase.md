...
| :--- | :--- | :--- |
| Capture | Session goal, decision, rejected path, risk, evidence, next step | A record of what the agent captured, not independent proof by itself |
...
| `/tracework:weekly` | Prepare a weekly brief |
